...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface MyOwnedERC721 extends BaseContract {
    
    connect(runner?: ContractRunner | null): MyOwnedERC721;
    waitForDeployment(): Promise<this>;

    interface: MyOwnedERC721Interface;
